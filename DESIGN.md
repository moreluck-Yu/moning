...
Moning 是一个智能化的个人习惯养成系统，通过多模态内容生成和多平台分发，实现早起打卡的数字化仪式感。
...
#### 3. 监控与错误处理 (Observability & Error Handling)
**职责**: 指标、性能与错误的统一管理

**关键组件**:
- `metrics.py`: 指标采集、健康报告、性能追踪
- `error_handler.py`: 统一异常分类、重试与降级策略
